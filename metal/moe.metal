...
/* GLM-5.2 IQ3_XXS lookup grid (uint32[256], verbatim from ggml-common.h /
 * ds4.c).  Each entry packs four bytes; indexing as uint8* gives the four
 * 4-element grid rows used by the IQ3_XXS dequant (down experts). */
static constant uint ds4_metal_iq3xxs_grid[256] = {
...
/* GLM-5.2 IQ4_XS lookup values (int8[16], from ggml-common.h kvalues_iq4nl).
 * Used by the IQ4_XS down-expert dequant (blk.8 + blk.75..77). */
static constant int8_t ds4_metal_kvalues_iq4nl[16] = {
    -127, -104, -83, -65, -49, -35, -22, -10, 1, 13, 25, 38, 53, 69, 89, 113,
};
#define kvalues_iq4nl ds4_metal_kvalues_iq4nl
