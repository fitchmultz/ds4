...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  ...
  primitives plus layer-major MLA and dense-FFN batch composites are now tested), NextN/MTP speculative decode,
