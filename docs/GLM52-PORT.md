...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  ...
  primitives plus layer-major MLA, dense-FFN, and MoE-router batch composites are now tested), NextN/MTP speculative decode,
