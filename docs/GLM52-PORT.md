...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  batched prefill; the small GLM F32 batch matmul/RMSNorm/RoPE Metal primitives
  are now tested), NextN/MTP speculative decode, and controlled hot-expert SSD cache/prefetch.
