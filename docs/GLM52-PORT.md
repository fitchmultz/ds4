...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  ...
  primitives and a layer-major MLA batch composite are now tested), NextN/MTP speculative decode,
