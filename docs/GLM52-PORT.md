...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  ...
  primitives plus layer-major MLA, dense-FFN, dense residual-block, MoE-router, and F32 routed-MoE batch composites are now tested), NextN/MTP speculative decode,
