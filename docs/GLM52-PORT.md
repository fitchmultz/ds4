...
- Next meaningful bar-movers: GLM-specific persistent/batched graph (especially
  ...
  primitives are now tested), NextN/MTP speculative decode, and controlled hot-expert SSD cache/prefetch.
