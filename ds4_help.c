...
static void print_cli_diagnostics(FILE *fp, const help_colors *c) {
    ...
    opt(fp, c, "DS4_GLM_MLA_DIRECT_QA_QK=0/off", "GLM fast path: disable the default direct Q5_K/Q6_K MLA attn_q_a projection used by DS4_GLM_FAST=1. Set =1 to force it when testing env handling.");
    ...
    opt(fp, c, "DS4_GLM_SHEXP_DIRECT_QK=0/off", "GLM fast path: disable the default direct shared-expert Q5_K/Q6_K/Q8_0 path and restore the resident F32 shared-expert cache.");
